...
public class BackpackConfig {
    ...
    public DSLContext getHikariDslContext(BackpackApplicationConfigRecord applicationConfigRecord) throws SQLException {
    ...
    @Bean
    @LiquibaseDataSource
    public DataSource getLiquibaseDataSource(BackpackApplicationConfigRecord applicationConfigRecord) {
        return getHikariDataSource(applicationConfigRecord);
    }

    @Bean
    public JdbcConnectionDetails jdbcConnectionDetails(BackpackApplicationConfigRecord backpackApplicationConfigRecord) {
    ...
    private HikariDataSource getHikariDataSource(BackpackApplicationConfigRecord applicationConfigRecord) {
